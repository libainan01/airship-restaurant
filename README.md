...
M3 食谱叙事基础现已开始：ContentRegistry 能定义并校验角色、客人、故事事件、
本地化和食谱日志；NarrativeSystem 只接收在线经营增量，支持优先级、前置条件、
去重、已读、完成、回看状态和旧存档恢复。管理窗口新增默认折叠的“食谱故事”区。
当前人物、旅人和归航炖锅文本都是系统验证占位，不代表正式剧情决定。

下一批优先推进内容：

1. 确认主角、第一位客人和第一张情感食谱；
2. 编排首次 15—30 分钟的经营、人物互动与食谱意义变化；
3. 用正式内容替换占位事件，并完善对话／信件／回忆等阅读表现；
4. 整理首批角色、食谱卡和界面美术需求；
5. 2 小时常驻与 Windows 平台矩阵保留到阶段验收时补做。
